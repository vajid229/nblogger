    ...
    return (
        <form onSubmit={handleSubmit(submit)} className="flex flex-wrap">
            <div className="w-full lg:w-2/3 px-2">
                ...
                <Input
                    label={<p className='text-[#33313B]'>Title <span className='text-red-500'>*</span>:</p>}
                    placeholder="Title"
                    className="mb-4 "
                ...
                <Input
                    label={<p className='text-[#33313B]' >Slug <span className='text-red-500'>*</span>:</p>}
                    placeholder="Slug"
                    className="mb-4"
                ...
                <RTE label={<p className='text-[#33313B]' > Content :</p>} name="content" control={control} defaultValue={getValues("content")} />

                <Input 
                    label={<p className='text-[#33313B]' > Author :</p>}
                    placeholder="Author"
                    className="mb-4"
                    {...register("author")}
                />
            ...
            <div className="w-full lg:w-1/3 px-2">
                <Input
                    label={<p className='text-[#33313B]'>Featured Image <span className='text-red-500'>*</span>:</p>}
                    type="file"
                    className="mb-4"
