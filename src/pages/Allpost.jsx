...
function AllPosts() {
  ...
  return (
    <div className='w-full py-8'>
      <div>
        <h1 className='text-[2rem] md:text-[2.5rem] text-center text-[#33313B] font-semibold'>All Posts</h1>
      </div>
      <Container>
        {
          loading ? (
              ...
              <p>Nothing to Show</p>
              {
                authStatus ? (
                  <Button
                    ...
                    className="mt-4 bg-customPink text-black rounded-xl px-5 py-2 hover:bg-black hover:text-grey hover:border hover:border-solid hover:border-grayBorder hover:cursor-pointer"
                  >
                    Add Post
                  </Button>
                ) : (
